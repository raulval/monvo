...
- 📋 Pre-built checklists (Travel, Move, Wedding, and more)
- ➕ Add, edit, and customize checklist items
- 📊 Visual progress tracking
- ⏰ Reminders and notifications
- 🤖 AI-generated personalized checklists (Premium)
- 📄 Export checklists to PDF (Premium)
...
- Generate personalized checklists automatically
- Adapt suggestions based on event type, duration, and context
...
This project is built with a modern and scalable mobile stack:

- **React Native** – Cross-platform mobile development
- **Expo** – Tooling, build system, and native APIs
- **TypeScript** – Type safety and maintainability
- **Tailwind CSS (Uniwind)** – Utility-first styling
- **Expo SQLite (ExpoSQL)** – Local database for offline-first data
- **Firebase**
  - Authentication (anonymous & optional login)
  - Cloud Firestore
  - Push Notifications
